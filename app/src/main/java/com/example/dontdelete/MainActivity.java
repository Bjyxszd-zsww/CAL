    ...
    public boolean onOptionsItemSelected( MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.Tran:
                ...
                break;
            case R.id.Volume:
                Intent intent3 = new Intent(MainActivity.this, volumeActivity.class);
                startActivity(intent3);
                break;
            case R.id.Square:
                Intent intent4 = new Intent(MainActivity.this, squareActivity.class);
                startActivity(intent4);
                break;
            case R.id.Temperature:
                Intent intent5 = new Intent(MainActivity.this, temperatureActivity.class);
       ...
       final TextView tv = findViewById(R.id.text_input);
        ...
        button_cos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String s = getLastN(s1,1);
                Double d = Double.parseDouble(s);
                Double b = Math.cos(d*Math.PI/180);
                Log.d("tag","b的值是："+b);
                String s2 = deleteStrings(s1,1);
                toCal.setLength(0);
                toCal.append(s2);
        ...
        button_sin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String s = getLastN(s1,1);
                Double d = Double.parseDouble(s);
                Double b = Math.sin(d*Math.PI/180);
                Log.d("tag","b的值是："+b);
                String s2 = deleteStrings(s1,1);
                toCal.setLength(0);
                toCal.append(s2);
        ...
        button_tan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String s = getLastN(s1,1);
                Double d = Double.parseDouble(s);
                Double b = Math.tan(d*Math.PI/180);
                Log.d("tag","b的值是："+b);
                String s2 = deleteStrings(s1,1);
                toCal.setLength(0);
                toCal.append(s2);
